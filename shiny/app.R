...
model_tb_plhiv <- function(d, d_ltbi, params) {
  ...
  d <- d %>% mutate(initiate_ipt_new=(ltbi_new + no_tb_new)*initiate_ipt_covg_new,
                    initiate_3hp_new=(ltbi_new + no_tb_new)*initiate_3hp_covg_new,
                    initiate_1hp_new=(ltbi_new + no_tb_new)*initiate_1hp_covg_new,
                    initiate_3hr_new=(ltbi_new + no_tb_new)*initiate_3hr_covg_new,
                    initiate_ipt_ltbi_new=ltbi_new*initiate_ipt_covg_new,
                    initiate_3hp_ltbi_new=ltbi_new*initiate_3hp_covg_new,
                    initiate_1hp_ltbi_new=ltbi_new*initiate_1hp_covg_new,
                    initiate_3hr_ltbi_new=ltbi_new*initiate_3hr_covg_new,
                    tox_nohosp_ipt_new=initiate_ipt_new*params$p_tox_nohosp_ipt,
                    tox_nohosp_3hp_new=initiate_3hp_new*params$p_tox_nohosp_3hp,
                    tox_nohosp_1hp_new=initiate_1hp_new*params$p_tox_nohosp_1hp,
                    tox_nohosp_3hr_new=initiate_3hr_new*params$p_tox_nohosp_3hr,
                    ...
                    part_complete_3hr_new=initiate_3hr_new - 
                      (complete_3hr_new + tox_nohosp_3hr_new + tox_hosp_3hr_new))
  d <- d %>% mutate(initiate_ipt_est=(ltbi_est + no_tb_est)*initiate_ipt_covg_est,
                    initiate_3hp_est=(ltbi_est + no_tb_est)*initiate_3hp_covg_est,
                    initiate_1hp_est=(ltbi_est + no_tb_est)*initiate_1hp_covg_est,
                    initiate_3hr_est=(ltbi_est + no_tb_est)*initiate_3hr_covg_est,
                    initiate_ipt_ltbi_est=ltbi_est*initiate_ipt_covg_est,
                    initiate_3hp_ltbi_est=ltbi_est*initiate_3hp_covg_est,
                    initiate_1hp_ltbi_est=ltbi_est*initiate_1hp_covg_est,
                    initiate_3hr_ltbi_est=ltbi_est*initiate_3hr_covg_est,
                    tox_nohosp_ipt_est=initiate_ipt_est*params$p_tox_nohosp_ipt,
                    tox_nohosp_3hp_est=initiate_3hp_est*params$p_tox_nohosp_3hp,
                    tox_nohosp_1hp_est=initiate_1hp_est*params$p_tox_nohosp_1hp,
                    tox_nohosp_3hr_est=initiate_3hr_est*params$p_tox_nohosp_3hr,
  ...
  #Step 2: TB deaths (also include for those that will progress this timestep - otherwise no opportunty to die if notified)
  #calculate deaths based on previous timestep - no need to stratify by new vs. previously enrolled
  deaths_output <- model_deaths_plhiv(d, d_ltbi, d_covg, params)
  tb_deaths <- deaths_output[[1]]
  non_tb_deaths <- deaths_output[[2]]
...
tpt_covg_plhiv <- function(d, params, option_split) {
  d <- d %>% 
    mutate(flag=(initiate_3hp_num + initiate_1hp_num + initiate_3hr_num + initiate_ipt_num)/
             ((plhiv_new + backlog - active_tb_new - active_tb_est)*1-params$p_initiate))
  if(option_split==2) { #prioritize newly enrolled PLHIV
      ...
      mutate(initiate_tpt_covg_new=pmin(1, 
             ...
             initiate_tpt_covg_est=pmin(1, 
                                        (initiate_3hp_num + initiate_1hp_num + initiate_3hr_num + initiate_ipt_num -
                                          ...
                                          (backlog*(1-active_tb_est/backlog))),
             ...
             initiate_ipt_covg_est=if_else(initiate_tpt_covg_est==0, 0,
                                           initiate_tpt_covg_est*(initiate_ipt_num - initiate_ipt_covg_new*(plhiv_new-active_tb_new))/
                                             (initiate_3hp_num+initiate_1hp_num+initiate_3hr_num+initiate_ipt_num - 
                                                initiate_tpt_covg_new*(plhiv_new - active_tb_new)))
             #initiate_3hp_covg_est=(initiate_3hp_num - initiate_3hp_covg_new*plhiv_new*(1-active_tb_new/plhiv_new))/
              #                            (backlog*(1-active_tb_est/backlog)),
             #initiate_1hp_covg_est=(initiate_1hp_num - initiate_1hp_covg_new*plhiv_new*(1-active_tb_new/plhiv_new))/
              # (backlog*(1-active_tb_est/backlog)),
             #initiate_3hr_covg_est=(initiate_3hr_num - initiate_3hr_covg_new*plhiv_new*(1-active_tb_new/plhiv_new))/
              # (backlog*(1-active_tb_est/backlog)),
             #initiate_ipt_covg_est=(initiate_ipt_num - initiate_ipt_covg_new*plhiv_new*(1-active_tb_new/plhiv_new))/
              # (backlog*(1-active_tb_est/backlog)),
      )
    ...
    d <- d %>% 
      mutate(initiate_3hp_covg=if_else(initiate_3hp_num==0, 0,
                                    ...
                                    initiate_3hp_num/(plhiv_new + backlog - active_tb_new - active_tb_est))),
             ...
             initiate_1hp_covg=if_else(initiate_3hp_num==0, 0,
                                    ...
                                    initiate_1hp_num/(plhiv_new + backlog - active_tb_new - active_tb_est))),
             ...
             initiate_3hr_covg=if_else(initiate_3hp_num==0, 0,
                                    ...
                                    initiate_3hr_num/(plhiv_new + backlog - active_tb_new - active_tb_est))),
             ...
             initiate_ipt_covg=if_else(initiate_3hp_num==0, 0,
                                    ...
                                    initiate_ipt_num/(plhiv_new + backlog - active_tb_new - active_tb_est))),
...
run_model_plhiv <- function(country_name, regimen, covg, scenarios, options, params, pop_calcs, option_split) {
  policy_horizon <- 10 #for now, implement over 10 years and calculate costs/outcomes over 10 years
  analytic_horizon <- 10
  start_yr <- 2024
  end_yr <- start_yr + analytic_horizon - 1
  ...
  plhiv <- plhiv %>% 
    mutate(ltbi_new=plhiv_new*params$p_ltbi*(1-params$p_reactivate_new[[1]]),
           active_tb_new=plhiv_new*params$p_ltbi*params$p_reactivate_new[[1]],
           no_tb_new=plhiv_new*(1-params$p_ltbi),
           ltbi_est=backlog*params$p_ltbi*(1-params$p_reactivate_est[[1]]),
           active_tb_est=backlog*params$p_ltbi*params$p_reactivate_est[[1]],
           no_tb_est=backlog*(1-params$p_ltbi),
           ltbi_ltfu=0,
           active_tb_ltfu=0,
           no_tb_ltfu=0)
  ...
  plhiv_ltbi <- cbind("t"=1,
                      plhiv %>% select(country, code, year, scenario,
                                     ltbi_new, ltbi_est, ltbi_ltfu))
  plhiv_ltbi <- do.call("rbind", replicate(10, plhiv_ltbi, simplify=F))
  ts <- unlist(lapply(1:10, function(x) rep(x, nrow(plhiv))))
  plhiv_ltbi <- plhiv_ltbi %>% mutate(t=ts)
  plhiv_ltbi <- plhiv_ltbi %>% mutate(ltbi_new=if_else(t==1, ltbi_new, 0),
                                      ltbi_est=if_else(t==1, ltbi_est, 0),
                                      ltbi_ltfu=if_else(t==1, ltbi_ltfu, 0))
  plhiv_ltbi <- plhiv_ltbi %>% mutate(p_reactivate_new=p_reactivate_new[t],
                                      p_reactivate_est=p_reactivate_est[t],
                                      p_reactivate_ltfu=p_reactivate_ltfu[t])
  plhiv_ltbi <- sapply(c('ltbi_new', 'ltbi_est', 'ltbi_ltfu'), function(x)
